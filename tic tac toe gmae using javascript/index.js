...
let squares=[];
    function end(num1,num2,num3){
        ...
        document.getElementById('item'+num1).style.background='rgb(55, 180, 94)';
        document.getElementById('item'+num2).style.background='rgb(55, 180, 94)';
        document.getElementById('item'+num3).style.background='rgb(55, 180, 94)';
